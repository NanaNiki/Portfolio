    ...
    <section className="projects" id="projects">
      ...
      <div className="divider-1">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120">
          ...
          ></path>
          <path
            d="M0,0H1200V5.63c-149.93,53.32-314.09,65.64-475.83,36.89-43-7.64-84.23-20.12-127.61-26.46-59-8.63-112.48,12.24-165.56,35.4C372.07,68.22,314,86.24,248.8,81c-86.53-7-172.46-45.71-248.8-84.81V0Z"
            class="shape-fill"
          ></path>
        </svg>
      </div>
