...
export default function EmotionAssistant({ setShowPopUp, setSelectedPopUp }) {
  return (
    <div className="z-10 w-full p-4 rounded-3xl shadow-lg m-2 bg-gray-300 shadow-slate-500 dark:bg-transparent dark:shadow-gray-600 animated-item slide-in delay-300">
      <img
        src="images/emotions.png"
        alt="SPA like app gif"
        className="w-11/12 h-[194px] object-cover rounded-3xl mx-auto"
      />
      <h2 className="font-bold text-lg my-2 text-slate-900 dark:text-white">
